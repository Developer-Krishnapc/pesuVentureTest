...
class CustomFormField extends ConsumerStatefulWidget with FormValidationMixin {
  ...
  factory CustomFormField.name({
    ...
    bool? isOptional,
      ...
      CustomFormField(
        inputFormatters: (isUserName == true)
            ? [
      ...
      CustomFormField(
        ...
        validator: (String? phone) {
          ...
          if (phone.startsWith('0')) {
            return '${label ?? 'Mobile number'} should not start with zero';
          }

          if (phone.length != 10) {
            return '${label ?? 'Mobile number'}  should be of 10 digits';
          }
      ...
      decoration: InputDecoration(
        focusedBorder: OutlineInputBorder(
          borderSide: BorderSide(
            color: widget.enabledColor ?? AppColor.grey,
          ),
        ),
        ...
        enabledBorder: OutlineInputBorder(
          borderSide: BorderSide(
            color: widget.focusColor ?? AppColor.grey,
          ),
